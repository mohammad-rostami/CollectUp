...
public class TransformImageView extends ImageView {
   ...
   */
  public void setImageUri(@NonNull Uri imageUri, @Nullable Uri outputUri, final BitmapLoadCallback listener) throws Exception {
...
//    compresedBitmap = BitmapFactory.decodeFile(filePath);
    ...
    BitmapLoadUtils.decodeBitmapInBackground(getContext(), imageUri, outputUri, maxBitmapSize, maxBitmapSize,
      new BitmapLoadCallback() {
        ...
        public void onBitmapLoaded(@NonNull Bitmap bitmap, @NonNull ExifInfo exifInfo, @NonNull String imageInputPath, @Nullable String imageOutputPath) {
          ...
          try
          {
            bitmap = Utility.compressJpeg(getContext(), mImageInputPath);
            setImageBitmap(bitmap);
            if (listener != null)
            {
              listener.onBitmapLoaded(bitmap, mExifInfo, mImageInputPath, mImageOutputPath);
            }
          } catch (IOException e)
          {
            e.printStackTrace();
