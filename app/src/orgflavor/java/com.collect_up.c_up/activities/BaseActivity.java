...
/*  @Override
  public final void onMenuNotificationsClick() {
    ...
    {
      Intent intent = new Intent(getApplicationContext(), FragmentNotifications.class);
...
/*  @Override
  public final void onMenuTimelineClick() {
    ...
    {
      startActivity(new Intent(getApplicationContext(), FragmentTimeline.class).addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT));
    }
  }*/
