...
public class ShopTimelineAdapter extends UltimateViewAdapter<ShopTimelineAdapter.Holder>
  ...
  public ShopTimelineAdapter(Context context, List<Post> postList) {
  ...
  private void bindFeedItem(int position, final Holder holder) {
    ...
    if (item.getProfileTags() != null && item.getProfileTags().size() > 0)
    {
      ...
      Hashtable<ShopTimelineAdapter.Holder, Post> hashtableTagPeople = new Hashtable<>();
  ...
  public void onClick(final View view) {
    switch (view.getId())
    {
      ...
      case R.id.image_button_more:
        ...
        if (onFeedItemClickListener != null)
        {
          onFeedItemClickListener.onTimelineMoreClick(view, postt.getId(), postt, position);
        }
        break;
      ...
      case R.id.btnOverflow:
        ...
        break;
      case R.id.btnTag:
        final Hashtable<ShopTimelineAdapter.Holder, Post> tagPeopleMap = (Hashtable<ShopTimelineAdapter.Holder, Post>) ((FrameLayout) view.getParent()).getTag();
        final ShopTimelineAdapter.Holder btnTagPeople = tagPeopleMap.keys().nextElement();
