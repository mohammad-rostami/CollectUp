...
public class SearchComplexesAdapter extends UltimateViewAdapter<SearchComplexesAdapter.Holder>
  implements View.OnClickListener {

  private final Context mContext;
  final private List<Complex> mComplexList;
  private ItemListener mListener;

  public SearchComplexesAdapter(Context context, List<Complex> complexList) {
    this.mComplexList = complexList;
    mContext = context;
  }

  public void update(Complex newComplex, boolean deleted) {
    for (Complex complex : mComplexList)
    {
      if (complex.getId().equals(newComplex.getId()))
      {
        int pos = mComplexList.indexOf(complex);
        if (deleted)
        {
          mComplexList.remove(pos);
          notifyItemRemoved(pos);
        } else
        {
          mComplexList.set(pos, newComplex);
  ...
  public Holder onCreateViewHolder(ViewGroup parent) {
    View view = LayoutInflater.from(parent.getContext())
      .inflate(R.layout.inf_search_complexes_item_grid, parent, false);
  ...
  public void onBindViewHolder(Holder holder, int position) {
    ...
    Complex item = mComplexList.get(position);
  ...
  public void onClick(View v) {
    switch (v.getId())
    {
      ...
      case R.id.text_view_name:
        ...
        if (mListener != null)
        {
          mListener.onComplexImageClick(complex);
        }
        break;
    }
  }
  ...
  public interface ItemListener {
    void onComplexImageClick(Complex complex);
  }
