...
public class FragmentPostLikes extends BaseFragment {
  ...
  public FragmentPostLikes(String mPostId) {
    this.mPostId = mPostId;
  }

  public FragmentPostLikes() {
  }
  ...
  public void onResume() {
    ((AppCompatActivity) getActivity()).getSupportActionBar().show();
    ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(R.string.post_likes);
  ...
  public void loadFirstPage() {
    ...
    mCurrentPage = 1;
    Pagination.getPostLikes(mCurrentPage, mPostId, getContext(), new IPaginationCallback() {
      @Override
      public <T> void onPageReceived(List<T> pageList) {
        ...
        mAdapter = new ContactAdapter(FragmentPostLikes.this, adapterDataSet);
