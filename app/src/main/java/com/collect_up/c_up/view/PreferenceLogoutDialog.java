...
public class PreferenceLogoutDialog extends Preference {

  @TargetApi(Build.VERSION_CODES.LOLLIPOP)
  public PreferenceLogoutDialog(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    super(context, attrs, defStyleAttr, defStyleRes);
  }

  public PreferenceLogoutDialog(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
  }

  public PreferenceLogoutDialog(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public PreferenceLogoutDialog(Context context) {
    super(context);
  }
  ...
  private com.rey.material.app.SimpleDialog buildDialog() {
    ...
    mDialogBuilder.positiveActionClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        HttpClient.post(getContext(), Constants.Server.OAuth.LOGOUT, "application/json", new AsyncHttpResponser(getContext(), Looper.myLooper()) {
          @Override
