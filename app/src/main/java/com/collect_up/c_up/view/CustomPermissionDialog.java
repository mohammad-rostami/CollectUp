 ...
 */
public class CustomPermissionDialog extends BasePermissionListener {
  ...
  private CustomPermissionDialog(Context context, String title, String message,
  ...
  public static class Builder {
    ...
    public CustomPermissionDialog build() {
      ...
      return new CustomPermissionDialog(context, title, message, buttonText, icon);
    }
  }
}
