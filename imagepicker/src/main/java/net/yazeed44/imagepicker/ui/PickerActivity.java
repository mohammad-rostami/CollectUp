...
public class PickerActivity extends AppCompatActivity {
    ...
    public void onClickDone(View view) {
        ...
        intent.putExtra("images", new ArrayList<>(sCheckedImages));
        intent.putExtra("popupThemeResId", mPickOptions.popupThemeResId);
        intent.putExtra("themeResId", mPickOptions.themeResId);
    ...
    public void capturePhoto() {
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                ActivityCompat.requestPermissions(this,
                        new String[]{Manifest.permission.CAMERA}, 15);
        ...
        else { final File captureImageFile = createTemporaryFileForCapturing(".png");
            CameraSupport.startPhotoCaptureActivity(this, captureImageFile, REQUEST_PORTRAIT_FFC);}
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu_cropper; this adds items to the action bar if it is present.
