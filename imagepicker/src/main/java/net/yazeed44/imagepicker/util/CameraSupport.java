...
public final class CameraSupport {
        ...
        if (enabled == null) {
            try {
               // Class.forName("com.commonsware.cwac.cam2.CameraActivity");
                 Class.forName("com.desmond.squarecamera.CameraActivity");
                enabled = true;
    ...
    public static void startPhotoCaptureActivity(Activity parent, File file, int requestCode) {
       Intent startCustomCameraIntent = new Intent(parent, CameraActivity.class);
        parent.startActivityForResult(startCustomCameraIntent, requestCode);
