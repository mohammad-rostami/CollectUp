...
public class FilePickerBuilder {
   ...
   */
  public FilePickerBuilder(Fragment context) {
    mContext = context;
  }
  ...
  public void launch() {
    Intent intent = build();
    mContext.startActivityForResult(intent, requestCode.ordinal());
  }
   ...
   */
  public Intent build() {
    Intent filePicker = new Intent(mContext.getActivity(), useMaterial ? FilePicker.class : FilePickerActivity.class);
